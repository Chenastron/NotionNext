const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-01-21', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.1231145.xyz' },
    { title: '访问文档中心获取更多帮助', url: 'https://docs.1231145.xyz' }
  ],
  ...
  HEO_HERO_TITLE_3: 'Chenastron',
  HEO_HERO_TITLE_4: '博客上线',
  HEO_HERO_TITLE_5: '真诚、友善、团结、专业',
  HEO_HERO_TITLE_LINK: 'https://blog.1231145.xyz',
  // 英雄区遮罩文字
  HEO_HERO_COVER_TITLE: '随便逛逛',

  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '必看精选', url: '/tag/必看精选' },
  HEO_HERO_CATEGORY_2: { title: '技术分享', url: '/tag/热门文章' },
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/Chenastron',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://www.1231145.xyz',
  ...
  HEO_SOCIAL_CARD_URL: 'https://docs.1231145.xyz/article/how-to-question',
